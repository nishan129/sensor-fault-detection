...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self)->ModelEvaluationArtifact:
        try:
            valid_train_file_path = self.data_validation_artifact.validation_train_file_path
            valid_test_file_path = self.data_validation_artifact.validation_test_file_path
