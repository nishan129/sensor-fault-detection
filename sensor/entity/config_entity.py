...
from sensor.constant.training_pipeline import (PIPELINE_NAME, ARTIFACT_DIR,
                ...
                FILE_NAME, DATA_INGESTION_INGESTED_DIR, TRAIN_FILE_NAME,
                TEST_FILE_NAME,DATA_INGESTION_TRAIN_TEST_SPILT_RATION,
...
class DataIngestionConfig:
    ...
    def __init__(self, training_pipeline_config:TrainingPipelineConfig):
        ...
        self.data_ingestion_dir : str = os.path.join(
            training_pipeline_config.artifcat_dir, DATA_INGESTION_DIR_NAME
        )
